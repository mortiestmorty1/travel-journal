...
import { faLocationCrosshairs, faLocationPinLock } from "@fortawesome/free-solid-svg-icons";
import "../App.css";
    ...
    return(
        <div className="content-container">
            ...
            <div className="section1">
                <FontAwesomeIcon icon={faLocationCrosshairs} className="Location"></FontAwesomeIcon>
