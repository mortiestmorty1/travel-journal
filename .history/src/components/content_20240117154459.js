...
import { faLocationCrosshairs, faLocationPin, faLocationPinLock } from "@fortawesome/free-solid-svg-icons";
import "../App.css";
    ...
    return(
        <div className="content-container">
            ...
            <div className="section1">
                <FontAwesomeIcon icon={faLocationPin} className="Location"></FontAwesomeIcon>
